...
# 파일 생성 : 파일 입출력 이용 , 쓰기 모드로 열기 , CP949 인코딩 , 줄바꿈 문자 해제
f = open(r'C:\Users\com\Documents\vscode workspace\Web_Crawling_Py\Crawling_Inflearn_NadoCoding\Inflearn\08_네이버_주식_크롤링\data.csv', 
