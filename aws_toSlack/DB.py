...
class Repo(object):
    def __init__(self):
        self.engine = create_engine(
            ...
            "mysql+pymysql://username:passwd-@username:3306/dbname?charset=utf8mb4",
            echo=True,
            future=True,
        )
...
# id , name , content , additional , startDate , link
    ...
    def get_crawling_data(self, name):
        ...
        query = query.filter(TblCrawlingData.name == name, TblCrawlingData.startDate >= datetime.now()-timedelta(days=3))
        return query.all()